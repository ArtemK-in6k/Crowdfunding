    ...
    <form id="forma" class="form-horizontal " action='/create' method="POST">
        ...
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="needAmount" name="needAmount" placeholder="" class="input-xlarge" required>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="projectName" name="projectName" placeholder="" class="input-xlarge" required>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <textarea id="aboutProject" name="aboutProject" rows="10" cols="100"  form="forma" style="resize: none" required>Enter here about your project...</textarea>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="image" name="image" placeholder="" class="input-xlarge" required>
                </div>
            </div>
