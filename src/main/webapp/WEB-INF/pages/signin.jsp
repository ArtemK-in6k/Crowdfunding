        ...
        <form name="regController.regForm" id="registerForm" action="/register" method="post">
            ...
            <div class="form-group">
                <div class="input-group">
                    <input name="firstName" ng-model="regController.form.firstName"
            ...
            <div class="form-group">
                <div class="input-group">
                    <input type="text" ng-model="regController.form.lastName" class="form-control" name="lastName"
            ...
            <div class="form-group">
                <div class="input-group">
                    <input type="password" ng-model="regController.form.password" class="form-control" name="password"
