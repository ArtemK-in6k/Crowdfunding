...
<div ng-controller="OwnProjects as ownProjects">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xs-12">
        ...
        <div ng-show="ownProjects.projectUpdateSuccess" class="alert-success alert text-center">Project {{ownProjects.projectCompleted}} completed</div>
        ...
        <table class="table table-hover table-project">
            ...
            <tr class="text-center" ng-repeat="project in ownProjects.projects | orderBy : 'id' ">
                ...
                <td>
                    ...
                    <button ng-if="project.status == 'FUNDED'" type="button" class="btn btn-primary btn-sm" ng-click="ownProjects.updateStatus('COMPLETED', project.id,project.nameProject)">Complete</button>
                </td>
                <td>
        ...
        <div ng-if="ownProjects.projects.length == 0" class="text-center text-danger"><h3>Sorry, you don't have any projects</h3></div>
    </div>
</div>
